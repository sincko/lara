...
Google Analytics è stato impostato su laryart.it con l'anonimizzazione degli indirizzi IP (anonymize_ip) e utilizza cookie di prima parte (impostati dal dominio laryart.it, non da terze parti).
...
Google Analytics è stato impostato con il parametro per l'anonimizzazione degli IP: l'ultimo ottetto dell'indirizzo IPv4 viene troncato prima della memorizzazione (es. 192.168.1.xxx).

## Dati raccolti da Google Analytics

Google Analytics 4 raccoglie eventi di navigazione: pagine visualizzate, pagina di provenienza (referrer), titolo della pagina, tipo di browser e dispositivo, risoluzione dello schermo, lingua del browser, posizione geografica approssimativa (paese e città), tempo di permanenza e interazioni con la pagina. I dati sono aggregati e anonimizzati; nessun dato personale identificativo viene raccolto da questo sito.
